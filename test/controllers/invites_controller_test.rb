...
class InvitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invite" do
    assert_difference("Invite.count") do
      post invites_url, params: { invite: { answer: @invite.answer, body: @invite.body, title: @invite.title } }
    end
  ...
  test "should update invite" do
    patch invite_url(@invite), params: { invite: { answer: @invite.answer, body: @invite.body, title: @invite.title } }
